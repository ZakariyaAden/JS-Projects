...
subBtn.addEventListener("click", () => {
    ...
    function binoEncode(arrForReverser) {
        ...
        let convertedstr = "";
        //let arrLength = arrForReverser.length
        for(let j = 1; j < 10;j++){
            convertedstr.append(arrForReverser[j])
        }
        return convertedstr;
    }
   
    convertedBino.innerHTML = "Converted String: " + binoEncode(addToArray(rawMsgInput.value))
